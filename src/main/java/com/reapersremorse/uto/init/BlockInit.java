...
public class BlockInit
{
    ...
    public static void registerItems(final RegistryEvent.Register <Block>event)
    {
        ...
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_white"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_orange"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_magenta"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_light_blue"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_yellow"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_lime"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_pink"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_gray"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_light_gray"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_cyan"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_purple"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_blue"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_brown"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_green"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_red"));
        event.getRegistry().register(new Block(Block.Properties.create(Material.ROCK).lightValue(15).hardnessAndResistance(1,1.0f).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)).setRegistryName("uto_covalence_block_black"));
