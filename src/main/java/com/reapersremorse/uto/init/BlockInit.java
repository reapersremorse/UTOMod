...
public class BlockInit
{
    ...
    {
        //basic blocks
        event.getRegistry().register(new BlockItem(uto_block,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_block"));
        event.getRegistry().register(new BlockItem(uto_bricks,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_bricks"));
        event.getRegistry().register(new BlockItem(uto_chiseled_bricks,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_chiseled_bricks"));
        event.getRegistry().register(new BlockItem(uto_cobblestone,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_cobblestone"));
        event.getRegistry().register(new BlockItem(uto_cracked_bricks,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_cracked_bricks"));
        event.getRegistry().register(new BlockItem(uto_end_stone,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_end_stone"));
        event.getRegistry().register(new BlockItem(uto_ore,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_ore"));
        event.getRegistry().register(new BlockItem(uto_smooth,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_smooth"));
        event.getRegistry().register(new BlockItem(uto_stone,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_stone"));

        //covalence dusts blocks
        event.getRegistry().register(new BlockItem(uto_covalence_block_white,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_white"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_orange,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_orange"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_magenta,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_magenta"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_light_blue,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_light_blue"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_yellow,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_yellow"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_lime,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_lime"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_pink,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_pink"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_gray,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_gray"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_light_gray,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_light_gray"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_cyan,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_cyan"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_purple,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_purple"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_blue,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_blue"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_brown,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_brown"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_green,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_green"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_red,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_red"));
        event.getRegistry().register(new BlockItem(uto_covalence_block_black,new Item.Properties().group(ItemGroup.MISC)).setRegistryName("uto_covalence_block_black"));
